  ...
  return (
    <Card className='w-[18rem]'>
            <div className={`${true?' cursor-pointer':"cursor-not-allowed"}relative`}>
                    ...
                    src="https://res.cloudinary.com/wejgrnjqf/image/upload/c_limit,w_3840/f_auto/q_auto/v1/74e12e14-3922-49c2-8c61-842b9950dce2?_a=BAVAZGE70" alt="Restaurant Poster" />
                <Chip 
                size="small"
